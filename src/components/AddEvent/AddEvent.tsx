import React, { forwardRef, Component, useEffect, useRef, useState, useImperativeHandle } from 'react';
import ReactQuill from 'react-quill';
import 'react-quill/dist/quill.snow.css';
import './AddEvent.css'
const AddEvent = forwardRef(({getAddEvent,newPost}:any ,ref) => {
